...
public class ArmageddonTest {
    ...
    class DecideIfRaise {
        ...
        class thirdRoundWinFirstRound {
            ...
            @Test
            @DisplayName("Should request truco in the third round if won the first round")
            void shouldRequestTrucoInThirdRoundIfWonFirstRound() {
                TrucoCard vira = TrucoCard.of(THREE, HEARTS);
                ...
                boolean result = armageddon.shouldRequestTrucoThirdRound(intel);
            ...
            void shouldRequestSixIfOpponentRequestsTrucoInThirdRound() {
                ...
                boolean result = armageddon.shouldRequestSix(intel, opponentRequestedTruco);
    ...
    class DecideIfNotRaises {
        ...
        class secondRoundWonFirstRoundTests {
            ...
            @Test
            @DisplayName("Should request Truco in the second round after winning the first round if bot has a Three or Manilha")
            void shouldRequestTrucoInSecondRoundIfHasThreeOrManilha() {
                ...
                TrucoCard opponentCard = TrucoCard.of(FOUR, DIAMONDS);
                List<TrucoCard> openCards = List.of(opponentCard);
