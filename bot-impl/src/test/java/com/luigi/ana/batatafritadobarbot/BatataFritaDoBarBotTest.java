...
public class BatataFritaDoBarBotTest {
    ...
    void makeSureThrowTheLowestCardToWin() {
        ...
        assertEquals(Optional.ofNullable(TrucoCard.of(CardRank.ACE, CardSuit.DIAMONDS)), batataFritaDoBarBot.getLowestToWin(stepBuilder.build()));

    }

    //23
    @Test
    @DisplayName("Ensure not to ask for truco if opponent is in hand of eleven")
    ...
    void shouldReturnAverageCardsIs4() {
        ...
        assertEquals(4.0, batataFritaDoBarBot.getAverageCardValue(stepBuilder.build()), 0.0001);
    }
    ...
    void shouldReturnAverageCardsIs1() {
        ...
        assertEquals(1, batataFritaDoBarBot.getAverageCardValue(stepBuilder.build()), 0.0001 );
    }
