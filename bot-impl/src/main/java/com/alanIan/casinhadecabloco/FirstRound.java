...
public class FirstRound implements GameState {
    ...
    public boolean decideIfRaises(GameIntel intel) {
        ...
        if (botScore >= 10 && winning(intel)) return conservative;
    ...
    public CardToPlay chooseCard(GameIntel intel) {
        ...
        if(numberOfManilhas() == 1 && numberOfStrongCards() > 1) return CardToPlay.of(hand.get(2));
        if(numberOfManilhas() == 1 && numberOfStrongCards() < 1) return CardToPlay.of(hand.get(1));
