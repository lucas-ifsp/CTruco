...
public class MeuBotTest {
    ...
    class GetMaoDeOnzeResponse {
        ...
        void testaMaoDeOnzeGanhouPrimeiraRodadaETemZap() {
            ...
            intel = createIntel(hand, vira, 11, 11, List.of(GameIntel.RoundResult.DREW));
        ...
        @Test
        @DisplayName("Aceita jogar mão de onze com 3 cartas de Aces")
        void aceitaMaoDeOnzeComTresCartasDeAces() {
            hand = List.of(
