/*
 *  Copyright (C) 2024 Bianca Carvalio Antonietti - IFSP/SCL and João Pedro Volante - IFSP/SCL
...
class LgtbotTest {
    ...
    class GetMaoDeOnzeResponseTest {
        ...
        @Test
        @DisplayName("Rejeitar mão de onze com cartas fracas, independentemente da pontuação do oponente")
        public void testShouldRejectMaoDeOnze_WithBadCards_RegardlessOfOpponentScore() {
            TrucoCard vira = TrucoCard.of(CardRank.FOUR, CardSuit.SPADES);
            List<TrucoCard> badCards = List.of(
